...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lblMaxIter = QtWidgets.QLabel(self.gridLayoutWidget)
        self.lblMaxIter.setObjectName("lblMaxIter")
        self.lytMaxIter.addWidget(self.lblMaxIter)
        self.spinMaxIter = QtWidgets.QSpinBox(self.gridLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spinMaxIter.sizePolicy().hasHeightForWidth())
        self.spinMaxIter.setSizePolicy(sizePolicy)
        self.spinMaxIter.setMinimum(10)
        self.spinMaxIter.setObjectName("spinMaxIter")
        self.lytMaxIter.addWidget(self.spinMaxIter)
        ...
        self.lytCustomK.addWidget(self.radioCustomK)
        ...
        self.lytCustomK.addWidget(self.spinCustomK)
        ...
        self.radioElbow.setChecked(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblMaxIter.setText(_translate("MainWindow", "Max iteration"))
        self.btnOpen.setText(_translate("MainWindow", "Open image"))
        self.radioCustomK.setText(_translate("MainWindow", "Custom K"))
        self.radioElbow.setText(_translate("MainWindow", "Optimal K (base on EV)"))
    ...
    def funcBtnExecute(self):
        if(ci.ori_img is None):
            ...
            if(self.radioCustomK.isChecked()):
                ...
                maxIter = self.spinMaxIter.value()
                ci.setKMeans(nbCentroid, maxIter)
                ci.runKMeans()
