...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 10, 701, 88))
        ...
        self.lytToolBox.addWidget(self.btnShowOri, 1, 4, 1, 1)
        self.btnShowRes = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.btnShowRes.setObjectName("btnShowRes")
        self.lytToolBox.addWidget(self.btnShowRes, 1, 6, 1, 1)
        self.lytRange = QtWidgets.QHBoxLayout()
        self.lytRange.setObjectName("lytRange")
        self.lblFrom = QtWidgets.QLabel(self.gridLayoutWidget)
        self.lblFrom.setObjectName("lblFrom")
        self.lytRange.addWidget(self.lblFrom)
        self.spinFrom = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.spinFrom.setEnabled(False)
        self.spinFrom.setMinimum(1)
        self.spinFrom.setObjectName("spinFrom")
        self.lytRange.addWidget(self.spinFrom)
        ...
        self.lytRange.addWidget(self.lblTo)
        self.spinTo = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.spinTo.setEnabled(False)
        self.spinTo.setMinimum(1)
        self.spinTo.setObjectName("spinTo")
        self.lytRange.addWidget(self.spinTo)
        self.lytToolBox.addLayout(self.lytRange, 2, 2, 1, 1)
        ...
        self.lytCustom = QtWidgets.QHBoxLayout()
        self.lytCustom.setObjectName("lytCustom")
        ...
        self.lytCustom.addWidget(self.radioCustomK)
        ...
        self.lytCustom.addWidget(self.spinCustomK)
        self.lytToolBox.addLayout(self.lytCustom, 2, 4, 1, 1)
        ...
        self.radioOptimal = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.radioOptimal.setObjectName("radioOptimal")
        self.lytToolBox.addWidget(self.radioOptimal, 2, 0, 1, 1)
        ...
        self.radioOptimal.clicked.connect(self.funcRadioOptimal)
        self.radioCustomK.clicked.connect(self.funcRadioCustomK)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioOptimal.setText(_translate("MainWindow", "Optimal K (Elbow)"))
    ...
    def funcBtnExecute(self):
        if(ci.ori_img is None):
            ...
            elif(self.radioOptimal.isChecked()):
                elfrom = self.spinFrom.value()
                elto = self.spinTo.value()
                ci.drawOptimalElbowPlot(elfrom, elto+1)
    
    def funcRadioOptimal(self):
        self.spinCustomK.setEnabled(False)
        self.spinFrom.setEnabled(True)
        self.spinTo.setEnabled(True)
    
    def funcRadioCustomK(self):
        self.spinCustomK.setEnabled(True)
        self.spinFrom.setEnabled(False)
        self.spinTo.setEnabled(False)
